...
-----------------------------
The following Solidity types (left column) are not part of the ABI, and are
mapped to an existing ABI type (right column):
...
+-------------------------------+-----------------------------------------------------------------------------+
|:ref:`enum<enums>`             |Maps to the smallest ``uint`` type that is large enough to hold all values.  |
